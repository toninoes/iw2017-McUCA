...
public class ActualizarCliente {
  ...
  public void testActualizarCliente() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='ROOT-2521314']/div/div[2]/div[5]/div/div/div/div[3]/table/tbody/tr[9]/td[2]")).click();
    ...
    driver.findElement(By.id("gwt-uid-9")).sendKeys("1");
